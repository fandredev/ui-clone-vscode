    ...
    <>
      <main className="bg-black opacity-95 text-white pb-10 border-b-gray-400 border-b-1 to_tablet:grid to_tablet:grid-cols-[1fr_65%] to_tablet:gap-16 to_tablet:px-[6rem] to_tablet:pb-32">
        <div className="xl:flex xl:justify-center xl:flex-col xl:items-start">
          ...
          <section className="flex items-center flex-wrap py-4 flex-col xl:items-start">
            <h1 className="text-5xl text-center leading-tight xl:text-start xl:text-6xl xl:leading-snug">
            ...
            <span className="text-sky-600 underline pb-3">
              ...
              <span className="text-version_text">or</span> other plataforms
            </span>
